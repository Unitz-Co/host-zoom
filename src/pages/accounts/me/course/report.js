...
import HomePage from '@uz/unitz-tool-pages/CourseReport';
import Navbar from '@uz/unitz-tool-components/Navbar';
import PageData from '../../../../data/PageDataQuery';
import i18n from 'i18n-js';

const CourseReportIdx = withPageContext((props) => {
  return (
    <App>
      <Layout location={props.location} PageData={PageData}>
        <DIV>
          ...
          <Layout.POS name="app-header">
            <Navbar helperUrl={`https://unitz.biz/${i18n.locale}/guides#course?referral=course_report`} />
          </Layout.POS>
...
export default CourseReportIdx;
