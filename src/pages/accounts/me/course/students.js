...
import HomePage from '@uz/unitz-tool-pages/CourseStudents';
      ...
      <Layout location={props.location} PageData={PageData}>
        <DIV>
          ...
          <Layout.POS name="app-header">
            <Navbar helperUrl={`https://unitz.biz/${i18n.locale}/guides#course?referral=course_students`} />
          </Layout.POS>
