...
import HomePage from '@uz/unitz-tool-pages/Settings';
import Navbar from '@uz/unitz-tool-components/Navbar';
import PageData from '../../../data/PageDataQuery';

const SettingsIdx = withPageContext((props) => {
  return (
    <App>
      <Layout location={props.location} PageData={PageData}>
        <DIV>
          ...
          <Layout.POS name="app-header">
            <Navbar helperUrl={`https://unitz.biz/${i18n.locale}/guides#setting?referral=settings`} />
          </Layout.POS>
