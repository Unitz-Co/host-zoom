...
import HomePage from '@uz/unitz-tool-pages/ProgramTemplateCreated';

import PageData from '../../../../data/PageDataQuery';

const ProgramTemplateCreatedIdx = withPageContext((props) => {
  return (
    <App>
...
export default ProgramTemplateCreatedIdx;
