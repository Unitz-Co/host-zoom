...
import HomePage from '@uz/unitz-tool-pages/ProgramTemplateDetail';
import Navbar from '@uz/unitz-tool-components/Navbar';
import PageData from '../../../../data/PageDataQuery';

const ProgramTemplateDetailIdx = withPageContext((props) => {
  return (
    <App>
...
export default ProgramTemplateDetailIdx;
