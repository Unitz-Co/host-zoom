...
import HomePage from '@uz/unitz-tool-pages/ProgramTemplateCreate';

import PageData from '../../../../data/PageDataQuery';

const ProgramTemplatesCreatorIdx = withPageContext((props) => {
  return (
    <App>
...
export default ProgramTemplatesCreatorIdx;
