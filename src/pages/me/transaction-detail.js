...
import UserTransactionHistoryDetail from '@uz/unitz-pages/UserTransactionHistoryDetail';

import PageData from '../../data/PageDataQuery';

const UserTransactionHistoryIdx = withPageContext((props) => {
  return (
    <App>
...
export default UserTransactionHistoryIdx;
